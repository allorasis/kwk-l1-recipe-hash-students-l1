...
# All of the ingredients should be symbols and the amounts should be strings. Remember that symbols start with a colon and be sure to sub underscores for spaces.
 perfect_10_recipe = {:cups_of_almond_flour => "2",:cup_of_gluten_freewhole_oats => "1", :tsp_kosher_salt => "1/2", :tsp_baking_powder => "1/2", :tsp_Xanthan_Gum => "1/2", :cup_slivered_almonds_lightly_toasted => "1/4", :cup_mini_dark_choco_chips => "3/4", :cup_olive_oil => "1/2", :cup_agave => "1/4"} 
